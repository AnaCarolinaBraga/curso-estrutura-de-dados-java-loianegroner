...
public class Vetor {
    ...
    //Procura se determinado elemento está dentro do vetor retornando a posição dele
    ...
    /*Outra forma de fazer: Procura se determinado elemento está dentro do vetor retornando booleano
	public int busca(String elemento) {
		for (int i=0; i<this.tamanho; i++) {
			if(this.elementos[i].equals(elemento)) {
				return i;
